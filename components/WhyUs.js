...
<div className="bg-[#fffdf2] flex flex-col lg:flex-row mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
  <div className="w-full border">
    <div className="relative lg:flex lg:gap-x-20 lg:px-20">
      <div className="mx-auto max-w-lg text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
        <div className="relative isolate overflow-hidden text-gray-900 bg-white py-16 lg:py-0 shadow-2xl sm:rounded-3xl sm:px-12 md:pt-24">
          <h2 className="text-3xl font-bold tracking-tight text-[#0F172A] sm:text-[56px] mb-5">
            Why join us
          </h2>
          <ul className="flex flex-col justify-start items-start gap-y-1.5 mt-6 text-lg text-gray-300">
      ...
      <div className="hidden lg:block">
        <div className="absolute right-0 bottom-0 z-30 lg:max-w-[38rem] rounded-md bg-white/5 ring-1 ring-white/10 ">
          <Image
            src={desktop}
            alt="desktop"
            width={700}
    ...
    <div className="relative lg:hidden">
      <Image
        className="mx-auto mt-8 lg:mt-0 rounded-md bg-white/5 ring-1 ring-white/10"
        src={desktop}
        alt="desktop"
        width={300}
        height={268}
