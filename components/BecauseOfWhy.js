...
<div className="mx-auto max-w-7xl py-16 sm:px-4 lg:px-6">
  ...
  <div className="bg-[#FDE68A] px-16 pt-5 rounded-sm h-96 overflow-x-auto lg:overflow-x-visible overflow-y-hidden md:overflow-y-visible">
    <ul
      role="list"
      className="flex lg:grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 xl:gap-x-8 lg:px-5 space-x-4 lg:space-x-0"
    >
      {people.map((person) => (
        <li
          key={person.iconname}
          className="flex-shrink-0 w-80 lg:w-auto flex flex-col rounded-[20px] bg-white text-center shadow"
        >
